# CREDITS TO: github.com/I-Am-Jakoby 
# MODIFIED BY: github.com/m-emadeddin
# Variables
...
$message = "Muhammed Emadeddin Sends his best regards,`ncares for you and your security, `nKeep yourself safe ....... with Love. `nCyberX"
